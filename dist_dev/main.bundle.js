...
var FRASES = [
    ...
    { fraseEng: 'How are you?', frasePtBr: 'como você esta?' },
    { fraseEng: 'I eat apple', frasePtBr: 'eu como maçã' }
];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__painel_frases_mock__ = __webpack_require__("./src/app/painel/frases-mock.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PainelComponent = /** @class */ (function () {
    function PainelComponent() {
        this.frases = __WEBPACK_IMPORTED_MODULE_1__painel_frases_mock__["a" /* FRASES */];
...
var TentativasComponent = /** @class */ (function () {
    ...
    TentativasComponent.prototype.ngOnChanges = function () {
        if (this.tentativa !== this.coracoes.length) {
            var index = this.coracoes.length - this.tentativa;
...
module.exports = "<nav class=\"navbar navbar-ligth bg-faded\">\r\n    <h1 class=\"navbar-brand mb-0\">{{ titulo }}</h1>\r\n  </nav>"
